...
public class InterfaceAddLog extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent evento) {
		if (evento.getSource() == botaoAddLog){
			...
			textAddLog.setText(" ");
			//A fun��o de lerCSV e gravarCSV deve ficar aqui!
			...
			//Deve usar o nome do arquivo digitado no textFild para chamar o a fun��o lerCSV e passar o resultado para gravarCSV
		}
